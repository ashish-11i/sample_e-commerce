...
//
//	@Override
//	public SellerDto updateSeller(Integer sellerId, UpdateSellerRequest sellerDto) {
//		Seller existSeller = sellerRepo.findById(sellerId)
//				.orElseThrow(() -> new ResourceNotFoundException("User", "userID", sellerDto));
